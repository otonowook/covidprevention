...
pluralCaseList.push( {plural: "healthcenters/reserves", pascal: "HealthcenterReserve"} )

pluralCaseList.push( {plural: "isolationcamps/isolationCamps", pascal: "IsolationcampIsolationCamp"} )

pluralCaseList.push( {plural: "deliverycenters/deliveries", pascal: "DeliverycenterDelivery"} )


pluralCaseList.push( {plural: "testingcenters/tests", pascal: "TestingcenterTest"} )
