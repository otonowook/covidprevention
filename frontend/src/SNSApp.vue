            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="isolationCamps"
                        to="/isolationcamps/isolationCamps"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                description: '', 
                key: 'isolationCamps', 
                route: '/isolationcamps/isolationCamps',
                ImageUrl: '',
            },
            { 
                title: 'Delivery', 
                description: '', 
                key: 'deliveries', 
                route: '/deliverycenters/deliveries',
                ImageUrl: '',
            },
            { 
                title: 'Test', 
