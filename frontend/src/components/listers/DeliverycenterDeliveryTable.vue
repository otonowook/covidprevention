        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <DeliverycenterDelivery :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" @add="append" v-if="tick"/>
        ...
        data: () => ({
            ...
            headers: 
                [
                    ...
                    { text: "transferDt", value: "transferDt" },
                ],
            delivery : [],
            newValue: {},
            tick : true,
