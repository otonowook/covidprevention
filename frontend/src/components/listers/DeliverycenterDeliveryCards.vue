    ...
    <div>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <DeliverycenterDelivery :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <DeliverycenterDelivery :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import DeliverycenterDelivery from './../DeliverycenterDelivery.vue';

    export default {
        name: 'DeliverycenterDeliveryManager',
        components: {
            DeliverycenterDelivery,
        },
        props: {
            offline: Boolean
        },
